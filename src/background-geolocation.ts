...
*
    ...
    "preparedemo": "npm run build && cd demo && tns plugin remove nativescript-background-geolocation-lt && tns plugin add ../src",
    "setup": "cd ../demo && npm install && cd .. && npm run build && cd demo && tns plugin add ../src && cd ..",
...
export class BackgroundGeolocation {
  ...
  public static invokeHeadlessTask(event:any, completionHandler:Function) {
